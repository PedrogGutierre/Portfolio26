...
const experiences = [
  ...
  },
  {
    ...
    institution: "FIAP",
    location: "São Paulo, SP",
    description: "Em formação superior com foco em desenvolvimento Full-Stack, arquitetura de software, metodologias ágeis e integração de sistemas. Desenvolvimento de projetos práticos em Java, Python e React.",
    duration: "4 anos",
    icon: GraduationCap,
  },
  {
