...
const roles = ["Estudante de Engenharia de Software", "Desenvolvedor Full Stack",]
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              ...
              <div className="relative w-full h-[64px] sm:h-[96px] md:h-[120px] lg:h-[96px] xl:h-[120px] flex justify-start">

                <span className="absolute text-red-500 text-left w-full max-w-full whitespace-normal pr-2 lg:pr-12 leading-tight">
                  <ScrambleText
                    texts={roles}
                    scrambleSpeed={40}
                    revealSpeed={80}
